...
public class ClientController {
    ...
    @RequestMapping(value = "/clients/search/{city}")
    ResponseEntity<List<ClientDto>> getAllByGivenCity(@PathVariable String city) {
        logger.trace("getAllByGivenCity - method entered");
        var clients = clientService.getAllClientsByCity(city);
        var result = new ArrayList<>(clientConverter.convertModelsToDtos(clients));
        return new ResponseEntity<>(result, HttpStatus.OK);
    }
